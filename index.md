...
- 1-25 December [Advent of Code](https://adventofcode.com), a global event with daily tasks. Lille Kat has a shared leaderboard (click `[Leaderboard]` in line 2). Join with the code `968368-7136f90c`. Follow daily discussion on Lille Kat’s MS Teams channel.
